...
#SBATCH --output=/data/users/ltucker/influenzaData/pipeline/log/embeddings/embedding_scaling_%A_%a.log
#SBATCH --error=/data/users/ltucker/influenzaData/pipeline/log/embeddings/embedding_scaling_%A_%a.err
...
output_dir = '/data/users/ltucker/influenzaData/pipeline/output/jupyter_outputs'
...
for pct_idx, pct in enumerate(percentages):
    ...
    for repeat in range(n_repeats):
        ...
        mds = MDS(n_components=2, dissimilarity='precomputed', random_state=seed, n_init=4, init='random')
